$(document).ready(function () {
  ...
  function updateThemeIcon() {
    ...
    $("#theme-toggle").html(
      isDarkTheme ? '<i class="fas fa-sun"></i>' : '<i class="fas fa-moon"></i>'
    );
  }
  ...
  const recentProjects = [
    {
      ...
      Codigo: "https://github.com/CristianBolanos",
    },
    {
      title: "Ecommerce",
      description:
        "Ecommerce creada con nocode, Tecnologías utilizadas: react, typescripts,Vite. Cosas aprendidas a manejar la imaginación para perfecionar las instrucciones de los prompt a la IA en la creación del proyecto dando un buen manejo de IU y UX y su funcionalidad.",
      tipo: "video",
    ...
    },
    {
      title: "SOAT Ya",
      description:
        "Website venta de soat. Tecnologías utilizadas: HTML5, CSS3, JavaScript.",
      tipo: "imagen",
  ...
  $(document).ready(function () {
    ...
    projectsContainer.on("click", "video.card-video", function (e) {
      ...
      const overlay = $(this)
        .closest(".video-card-container")
        .find(".play-overlay-modern");
      if (this.paused) {
        overlay.fadeIn(150);
      } else {
        overlay.fadeOut(150);
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement(
    {
      pageLanguage: "es",
      includedLanguages: "en-CA,en,fr,it,pt,de,ru",
